...
const { collectImageUpload } = require('../multerConfig');
...
// Ruta para subir imágenes de la colecta
router.post('/upload', verifyToken, collectImageUpload.single('collectImage'), colectaController.uploadCollectImage);
